...
def main():
    ...
    parser.add_argument('-bV', type=int, default=60, help='Bass volume', dest='b_v')
    parser.add_argument('-mV', type=int, default=120, help='Melody volume', dest='m_v')
    parser.add_argument('-bO', type=int, default=2, help='Bass Octave', dest='b_o')
    parser.add_argument('-mO', type=int, default=5, help='Melody Octave', dest='m_o')
    ...
    midi_helper = MidiHelper(args.filename, args.bpm, args.b_v, args.m_v)
    ...
    scale = Scale(scale_name, args.b_o, args.m_o)
